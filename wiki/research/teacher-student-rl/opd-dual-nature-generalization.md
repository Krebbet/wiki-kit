...
- [[../../conflicts/opsa-vs-opd-pattern-transfer]] — open conflict: [[opsa-teacher-free-self-adaptation]] argues OPD's gains come from suppressing the student's own low-logp tokens and require no teacher at all, in tension with this page's claim that teacher-origin identity/content drives the same-origin vs cross-origin generalization split.
