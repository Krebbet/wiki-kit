...
- Mistral-7B step-by-step PPO: 77.9 $\rightarrow$ 84.1% GSM8K, 28.6 $\rightarrow$ 33.0% MATH greedy (Table 2); +verification $\rightarrow$ 89.1 / 43.5 (Table 3).
- Math-Shepherd PRM > human PRM800K on MATH at the same generator distribution (Fig. 3) — attributed to distribution match (PRM800K labelled GPT-4 traces, Math-Shepherd labels MetaMath traces) plus $4\times$ data volume.
