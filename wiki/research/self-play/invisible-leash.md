...
- [[_overview]]
- [[../rlvr-mechanics/es-broader-reasoning-coverage-grpo]] **(added 2026-08-28)** — Evolution Strategies exceeds base-model Pass@16/32 via a non-trajectory-sampling mechanism; method-class scope challenge to Theorem C.1, see [[../../conflicts/invisible-leash-vs-spiral-transfer]]
