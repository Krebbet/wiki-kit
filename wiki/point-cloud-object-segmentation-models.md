...
> **Scan-plane note (librarian, 2026-09-24).** The "~1.1 m" scan plane on this page is the **June capture rig** (a tripod carrying the stereo camera, `data/calib/rig_geometry.json`). The **prototype rover** scans at **0.2972 m** — sd 0.5 mm, seven independent down angles at open floor, drone-prototype `eda/EDA228-actuator-verification/FINDING.md` (2026-09-24; an earlier 0.337 m was wall hits read as floor). The ~1.1 m flat-slice cloud this page analyses is the **June kitchen capture** and the figure is correct for it. Anything re-derived for the **rover** takes 0.2972 m, and — new since 2026-09-24 — a tilt ladder adds height, but only as a **bracket** per surface (`r·Δ(tan τ)` wide) and on fewer than half the cells a station sees (EDA233). Canonical statement and the tilt consequences: [[tilting-2d-lidar-multiplane-capture]] §CORRECTION.
