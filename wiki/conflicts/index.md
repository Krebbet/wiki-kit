...
- [[mcpo-vs-dapo-mastered-prompts]] — discard all-correct prompts (DAPO Dynamic Sampling) or retain + regularise with hinge-KL (MCPO)? **2026-08-07 update:** [[../research/rl-optimizers/cue-grpo-rarity-credit]] sidesteps the regime by construction (requires a nondegenerate group) rather than taking a position.
