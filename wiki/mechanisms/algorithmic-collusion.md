...
**Empirical evidence that tacit collusion occurs.** Assad et al. (2024), studying the German gasoline market, found that duopoly stations experienced a 28% margin increase when *both* competitors adopted [[dynamic-pricing-overview|algorithmic pricing]]. Monopoly stations saw no change. The asymmetry between duopoly and monopoly is the characteristic signature of coordinated (not merely optimised) pricing. *(arXiv 2504.16592.)*
