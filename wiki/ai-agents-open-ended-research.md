...
- [[research-swarm-whistleblowing]] — complicates rather than confirms this page's pessimistic take: the same autonomous-research-swarm setting also produces emergent self-governance capacity, though it proved operationally insufficient without enforcement tools.
- [[debate-training-reward-hacking]] — parallel alignment-lens failure-mode framing: both surface concrete failure modes of RL/agentic training under fuzzy, hard-to-verify objectives rather than pure capability-chasing.
