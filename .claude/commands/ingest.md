...
<!-- DOMAIN-SLOT: takeaway-prompts -->
   ...
   - **Conflicts with existing wiki positions** — the wiki stays neutral in the reference layer and editorial in the strategy layer, so surface competing framings rather than silently adopting a new one.
   <!-- /DOMAIN-SLOT -->
